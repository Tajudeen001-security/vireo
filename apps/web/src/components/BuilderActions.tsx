  ...
  return (
    <>
      ...
      <button
        ...
        onClick={() => {
          window.open(
            "https://vercel.com/new/clone?repository-url=https://github.com/Tajudeen001-security/vireo&root-directory=apps/web",
            "_blank"
          );
        }}
        className="text-xs px-3 py-1.5 rounded-full bg-emerald-500 text-zinc-950 font-medium hover:bg-emerald-400 transition disabled:opacity-40 disabled:cursor-not-allowed"
      >
        Publish
      </button>
    </>
